...
import ru.alenbarkalov.game.config.KafkaProperties;

class JhipsterSampleGameServerKafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterSampleGameServerKafkaResource kafkaResource = new JhipsterSampleGameServerKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/jhipster-sample-game-server-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/jhipster-sample-game-server-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
