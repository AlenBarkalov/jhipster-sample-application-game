...
@RestController
@RequestMapping("/api/jhipster-sample-game-server-kafka")
public class JhipsterSampleGameServerKafkaResource {
    private final Logger log = LoggerFactory.getLogger(JhipsterSampleGameServerKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipsterSampleGameServerKafkaResource(KafkaProperties kafkaProperties) {
